...
router.get('/movie_from_actor/:actor', function (req, res, next) {
    ...
    const uri = 'mongodb+srv://NiccoloScarpante:Nicopalacio@finanza.jazzp.mongodb.net/Finanza?retryWrites=true&w=majority'
...
router.get('/movie_from_annoedurata/:length/:year', function (req, res, next) {
    console.log(req.params); //Leggo i parametri passati all'url
